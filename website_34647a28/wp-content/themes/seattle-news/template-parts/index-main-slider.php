<?php 
$seattle_news_big_news_slider_disabled = get_theme_mod('newsexo_big_news_slider_disabled', true); 
$seattle_news_theme_big_news_slider_category = get_theme_mod('newsexo_theme_big_news_slider_category');
$seattle_news_theme_big_static_news_category = get_theme_mod('newsexo_theme_big_static_news_category');

if($seattle_news_big_news_slider_disabled == true): ?>
	<!--Big News Section -->
			...
			<div class="row g-lg-2">
				...
				<div class="col-lg-6 col-md-12 wow animate zoomIn" data-wow-delay=".3s">
					...
					<div id="news-slider" class="owl-carousel owl-theme">
						...
						<?php
							$post_args = array( 'post_type' => 'post', 'posts_per_page' => 5, 'category__in' => $seattle_news_theme_big_news_slider_category, 'post__not_in'=>get_option("sticky_posts")) ;
				...
				<div class="col-lg-6 col-md-12">
					...
					<?php
							$post_args = array( 'post_type' => 'post', 'posts_per_page' => 4, 'category__in' => $seattle_news_theme_big_static_news_category, 'post__not_in'=>get_option("sticky_posts")) ;
								query_posts( $post_args );
								if(query_posts( $post_args ))
								{	
									while(have_posts()):the_post();
