			...
			?>		
					<figcaption class="post-content">
						...
						<div class="entry-content">
							...
							<a href="<?php the_permalink();?>" class="more-link"><?php echo esc_html(get_theme_mod('newsexo_read_more_button_text', __('Read More', 'seattle-news'))); ?></a>
							<?php } ?>
							<?php wp_link_pages( array( 'before' => '<div class="page-links">' . __( 'Pages:', 'seattle-news' ), 'after'  => '</div>', ) ); ?>
						</div>
					</figcaption>	
